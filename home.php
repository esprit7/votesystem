				    ...
				    <?php
				    	...
				    	if($vquery->num_rows > 0){
				    		...
				    		<div class="text-center">
					    		...
					    		<a href="#view" data-toggle="modal" class="btn btn-flat btn-primary btn-lg">Voir vote</a>
								<a href="resultat/result.php" data-toggle="modal" class="btn btn-flat btn-primary btn-lg">Voir Resultat</a>
					    	</div>
				    		<?php
				    	}
				    	else{
